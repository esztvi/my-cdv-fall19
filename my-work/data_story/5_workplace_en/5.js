...
d3.json("data.json").then(function(incomingData){
  ...
  graphgroups.append("rect")
    ...
    .selectAll("text")
            ...
            .enter()
            .append("text")
            .text(function (d) { return d.romania; })
            .attr("x", function (d) { return xScale(d.romania); })
            .style("fill", "white")
  ;
  graphgroups.append("rect")
    .attr("x", 0)
    ...
    .selectAll("text")
            ...
            .enter()
            .append("text")
            .text(function (d) { return d.austria; })
            .attr("x", function (d) { return -xScale(d.austria); })
            .style("fill", "white")
  ;
...
//         .style("fill", "white");
  ...
  function updateGraph(){
    ...
    //     {"visible": d.visible, "country":"austria", "data":d.austria}]}
    //   , d=>d.industry)
